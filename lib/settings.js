...
exports.coin = {
  ...
  "name": "Wiiicoin",
  // display_name: Public-facing coin name. Kept separate from `name` because `name` is the key used by existing MongoDB records.
  "display_name": "RVACoin",
  ...
  "symbol": "RVA",
  // display_symbol: Public-facing ticker. Kept separate so a legacy runtime symbol can remain available to integrations while the explorer is branded as RVA.
  "display_symbol": "RVA"
};
...
exports.block_page = {
  ...
  "genesis_block": "00000b001777b84e3fc65c8f9e7d4f0a17d59089fa78a45b1f3d6a74e94e96d6",
...
exports.transaction_page = {
  ...
  "genesis_tx": "8de1e34d0b5599b47e6214575a72961796b69dd5bd30816ae5335a40ef4aa6a7",
...
exports.markets_page = {
  ...
  //            Supported exchanges: altmarkets, dex-trade, freiexchange/freixlite, nonkyc, xeggex, yobit
  "exchanges": {
...
exports.api_page = {
  ...
  "sample_data": {
    ...
    "blockhash": "782dc8e599a0485a81e500e35d916df8c3bf78eca81fc3dbbcf1afb2f5279f29",
    ...
    "txhash": "b05a5c2dc86d0f89fb11699a3c24765e2a67707a708bcb649f2765192b865c79",
    ...
    "address": "wS5hQhjhCVz5ieP2k5W8avFZfyZg4JFMTd"
  },
  ...
  "public_apis": {
    ...
    "rpc": {
      // wiii_get: a collection of settings that pertain to the /api/tnft_get api endpoint
      ...
      "wg": {
        // enabled: Enable/disable the /api/wiii_get api endpoint (true/false)
        //          If set to false, the /api/wiii_get api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly)
        "enabled": true
      },
...
// Public branding is intentionally fixed independently of legacy database/RPC coin identifiers.
// Re-apply it after settings.json is loaded so older deployment files cannot unset or override it.
exports.coin.display_name = 'RVACoin';
exports.coin.display_symbol = 'RVA';
exports.shared_pages.page_header.page_title_image.enable_animation = false;
exports.masternodes_page.enabled = false;
exports.shared_pages.page_header.panels.masternodes_panel.enabled = false;
exports.shared_pages.page_header.panels.masternodes_panel.display_order = 0;
exports.shared_pages.page_header.panels.network_panel.enabled = true;
exports.shared_pages.page_header.panels.network_panel.display_order = 2;
exports.shared_pages.page_header.sticky_header = false;
